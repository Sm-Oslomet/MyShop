using System;
using MyShop.Models; // Includes System namepsace, provides basic lasses and base classes that define commonly used values and reference data types,
                        ...
                        // that the code bleongs to a models folder or a component within myshop app
{
                      ...
                      // class is a blueprint for objects taht contains fields, properties, methods and other members
    {
        ...
        public string Name { get; set; } = string.Empty;  // String and class must be declared with default 
